//! Client Handshake Finished Builder Buffer
...
pub struct BufStaticClientHandshakeFinished<const N: usize> {
    bytes_buf: [u8; N],
    bytes_len: usize,
    cipher_start: usize,
    cipher_end: usize,
...
impl<const N: usize> BufStaticClientHandshakeFinished<N> {
    ...
    #[inline]
    pub(crate) fn static_from_untyped<S: ClientHandshakeFinishedBuilder>(
        s: &S,
        ...
        // Handshake type client handshake finished
        buffer[5] = 0x14;
...
mod test_ok_basic_hash_finished {
    ...
    impl ClientHandshakeFinishedBuilder for Tester {

...
impl HkdfLabelSha256 {
    ...
    pub const fn tls13_res_binder() -> [u8; 20] {
        //b"tls13 res binder
        [
            0, 32, 16, 116, 108, 115, 49, 51, 32, 0x72, 0x65, 0x73, 0x20, 0x62, 0x69, 0x6E, 0x64,
            0x65, 0x72, 00,
        ]
    }
...
mod test_rfc8448 {
    ...
    use super::*;
    use hex_literal::hex;
    use hkdf::{hmac::Hmac, GenericHkdf, Hkdf};
    use sha2::Sha256;
    ...
    fn derived_sha256() -> ([u8; 32], GenericHkdf<Hmac<Sha256>>) {
        ...
        assert_eq!(
            label_derived,
            hex!(
                "00 20 0d 74 6c 73 31 33 20 64 65 72 69 76 65 64
